...
const PlaceOrder = () => {
  ...
  const handleStripeClick = async () => {
    console.log("Event sent successfully: handleStripeClick");
    const detectBrowser = () => {
      const userAgent = navigator.userAgent;
      console.log("User Agent:", userAgent);
    ...
    const produceEvent = async () => {
      try {
        ...
        const requestBody = {
          eventType: "system",
          eventName: "Payment Info Submitted",
          userData: {
            userId: localStorage.getItem("powerpush_user_id"),
            clientId:"41AB81A4-042b-48ED-9d68-03fa53351766",
            category: "event",
  ...
  const handleRazorpayClick = async () => {
    console.log("Event sent successfully: handleRazorpayClick");
    const detectBrowser = () => {
      const userAgent = navigator.userAgent;
      console.log("User Agent:", userAgent);
  ...
  const handleCashOnDeliveryClick = async () => {
    console.log("Event sent successfully: handleCashOnDeliveryClick");
    const detectBrowser = () => {
      const userAgent = navigator.userAgent;
      console.log("User Agent:", userAgent);
